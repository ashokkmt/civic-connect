...
type IssueRepository interface {
	...
	ListAuthorityByDepartment(ctx context.Context, departmentID string, statuses []domain.IssueStatus, limit int64) ([]*domain.Issue, error)
	...
	CloseIssue(ctx context.Context, id primitive.ObjectID, closedAt time.Time) error
