...
const VIEW_META: Record<HeadView, { title: string; subtitle: string }> = {
  dashboard: {
    ...
    subtitle: "Track departmental performance, moderation throughput, and issue lifecycle health.",
  },
  pending_issues: {
    title: "Pending Issues",
    subtitle: "Review reports, set severity, and assign workers during approval.",
  },
  worker_analytics: {
    title: "Worker Analytics",
    subtitle: "Compare worker output, pending load, and success rates across your department.",
  },
  worker_management: {
    title: "Worker Management",
    subtitle: "Create workers, search and filter worker records, and manage assignment operations.",
  },
  resolved_issues: {
    title: "Resolved Issues",
    subtitle: "Review completed work and close issues waiting for head confirmation.",
  },
  escalations: {
    title: "Escalations",
    subtitle: "Monitor escalated issues and reassign cases requiring department intervention.",
  },
};

export function AuthorityHeadNavbar({ activeView, onRefresh, isRefreshing }: AuthorityHeadNavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-[var(--border)] bg-[var(--surface)]/85 px-4 py-4 backdrop-blur-xl sm:px-7">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-zinc-500 dark:text-zinc-400">Authority head workspace</p>
